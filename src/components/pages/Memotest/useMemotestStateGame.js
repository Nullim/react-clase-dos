...
const crearCartasIniciales = () => {
    ...
    cartasIniciales.sort(() => .5 - Math.random())
    return cartasIniciales;
}

const useMemotestStateGame = () => {
    ...
    return { cartas, flipped, onClickCard, wonPairs, gameEnded, onRestart }
}
export default useMemotestStateGame
